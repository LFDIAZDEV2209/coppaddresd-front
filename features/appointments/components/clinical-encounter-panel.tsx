 ...
 * consulta. Tema claro unificado (fase 4.3): se reutiliza en el detalle de
 * cita y en el panel de formularios de la sala virtual.
 */
    ...
    <section className="flex flex-col gap-4 rounded-2xl border border-border bg-card p-5">
      ...
      <div className="grid grid-cols-1 gap-3 lg:grid-cols-3">
        ...
        <div className="flex flex-col gap-1.5">
          <Label className="text-[11.5px] font-semibold text-foreground/70">
            CIE-10 (búsqueda)
          </Label>
          <CatalogSearchSelect
