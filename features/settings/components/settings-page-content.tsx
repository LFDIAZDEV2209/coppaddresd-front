  ...
  return (
    <div className="flex flex-col gap-5 p-5">
      ...
      <div className="flex gap-6">
        <nav className="flex w-[232px] shrink-0 flex-col gap-1">
        ...
        <div className="flex flex-1 flex-col gap-6 rounded-[14px] border border-border bg-card p-6">
          <div className="flex items-center gap-3">
            <div className="flex size-[34px] items-center justify-center rounded-xl bg-primary-soft">
            ...
            <div className="flex gap-4">
              {[
                ...
                >
                  <div
                    className={cn(
                      "flex h-[118px] flex-col overflow-hidden rounded-xl border-2 p-3 transition-colors",
                  ...
                  >
                    <div className="flex h-5 items-center gap-1">
                      <div
                        ...
                        style={{ backgroundColor: t.bar1 }}
                      />
                    </div>
                    <div className="mt-auto flex flex-col gap-1">
                      <div
                        className="h-1 w-[38px] rounded-full"
                        style={{ backgroundColor: t.bar2 }}
                      />
                      <div
                        className="h-1 w-[44px] rounded-full"
                        style={{ backgroundColor: t.bar3 }}
                      />
                    </div>
                  </div>
