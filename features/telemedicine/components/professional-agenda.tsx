...
import type { AppointmentStatus, TelemedicineAppointmentDto } from "../types";
...
export function ProfessionalAgenda({
  ...
  const [cancelling, setCancelling] =
    useState<TelemedicineAppointmentDto | null>(null);
...
function groupByDay(appointments: TelemedicineAppointmentDto[]): DayGroup[] {
