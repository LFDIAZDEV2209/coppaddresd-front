...
const ACCENT_PALETTES: Record<string, { light: Record<string, string>; dark: Record<string, string> }> = {
  ...
  "#3B82F6": {
    // Azul (default actual)
    light: { primary: "#3B82F6", strong: "#2563EB", soft: "#DBEAFE", foreground: "#FFFFFF", sidebar: "#162032", sidebarForeground: "#CBD5E1" },
    dark:  { primary: "#3B82F6", strong: "#60A5FA", soft: "#1E3A5F", foreground: "#FFFFFF", sidebar: "#162032", sidebarForeground: "#94A3B8" },
  },
  "#123B63": {
    // Marino
