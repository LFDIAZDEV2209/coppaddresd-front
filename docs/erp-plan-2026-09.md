...
| 4.5 | Sala y formulario — Carlos | Sala y formulario con mayor presencia de blanco, jerarquía legible, responsive y controles de videollamada accesibles. | Ruta indicada: `/appointments/room/[id]`; verificar ruta real al comenzar. |
